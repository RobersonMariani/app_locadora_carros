...
class GetMultasByClienteUseCase
{
    public function __construct(
        private readonly MultaRepository $repository,
    ) {}

    public function execute(int $clienteId, ?MultaQueryData $query = null): LengthAwarePaginator|Collection
    {
        return $this->repository->getByCliente($clienteId, $query);
    }
}
