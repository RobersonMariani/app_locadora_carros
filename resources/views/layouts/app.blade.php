...
<body>
    <div id="app">
                        ...
                        @auth
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button"
                                    aria-expanded="false">Veículos</a>
        ...
        @auth
            <nav aria-label="breadcrumb" style="background: rgba(128, 128, 128, 0.205); padding:10px;">
                <ol class="breadcrumb" style="margin: auto; margin-left:5px">
